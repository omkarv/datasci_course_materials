...
def mapper(record):
    ...
    if is_straight and is_flush and is_4cardstraight: 
    ...
    elif is_flush and is_4cardstraight: 
         mr.emit_intermediate('flush', '1') 
    elif is_straight and is_4cardstraight: 
         mr.emit_intermediate('straight', '1')
    elif is_4cardstraight: 
         mr.emit_intermediate('4cardstraight', '1')
    elif is_pair and is_4cardstraight: 
         mr.emit_intermediate('4cardstraight', '1') 
    elif is_trip: 
